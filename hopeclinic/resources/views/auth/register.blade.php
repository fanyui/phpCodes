                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('phoneNum') ? ' has-error' : '' }}">
                            <label for="phoneNume" class="col-md-4 control-label">Phone Number</label>

                            <div class="col-md-6">
                                <input id="phoneNum" type="text" class="form-control" name="phoneNum" value="{{ old('phoneNum') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('accessLevel') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="accessLevel" type="text" class="form-control" name="accessLevel" value="{{ old('accessLevel') }}" required>
